...
df = pd.read_csv("final/bostoncrime_2023_7000_sample.csv", index_col="INCIDENT_NUMBER")
df = df.dropna()
st_image = Image.open("final/shutterstock_216617104.0.jpg")
st_image2 = Image.open("final/Boston-MA-Crime-Rate.jpg")
